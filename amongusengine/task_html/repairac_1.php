...
<p>
  The second half of this task is in the BASEMENT, in the ELECTRICAL area.
</p>

<?php
$basename = explode(".", explode("?", basename($_SERVER['REQUEST_URI']))[0])[0];
echo "\n\nTo complete the first half of the task: click <a href='/amongusengine/event.php?issuer=$_GET[playerID]&event=task&eventdata=taskID=$basename'>here</a>";
?>